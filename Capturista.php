...
<body style="background: url('./src/assets/Fondo6.jpg')no-repeat; background-position: center; background-size: cover;">
	<div style=" border-radius: 20px;  backdrop-filter: blur(0px); text-align: center; color: white; font-family: Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif; font-size: 35px;">
		BIENVENIDO A SEDIH
	</div>
	...
	<div class="col-6 mt-3;" style=" margin-left: auto; margin-right: auto">
		...
		<form class="row g-3;  "	
			...
			while ($valores = mysqli_fetch_array($query)) {
				echo '<div class="col-12 mt-3" style=" margin-left: auto; margin-right: auto;  border-radius: 20px;  backdrop-filter: blur(5px); text-align: center; color: cyan; font-family: Impact, Haettenschweiler, Arial Narrow Bold, sans-serif; font-size: 35px;"> Hotel ' . $valores['nombre'] . '</div>';
			}
			?>
